...
public class Product {
    ...
    /**
     * Mối quan hệ này chỉ ra rằng mỗi đối tượng Product có một đối tượng Inventory
     * liên quan.
     * 
     ...
     * ra lỗi.
     * 
     * orphanRemoval = true chỉ ra rằng khi đối tượng Inventory không được liên kết
     * với bất kỳ Product nào, nó sẽ được xóa khỏi cơ sở dữ liệu. Điều này đảm bảo
     * rằng chỉ có các Inventory liên quan đến Product mới được lưu trữ trong cơ sở
     * dữ liệu, và các Inventory không liên quan sẽ tự động bị xóa.
     * 
